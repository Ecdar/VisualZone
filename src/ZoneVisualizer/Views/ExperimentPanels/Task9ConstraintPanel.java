...
public class Task9ConstraintPanel extends ConstraintPanel {

    public Task9ConstraintPanel(double prefWidth) {
        super(prefWidth);
    }
    ...
    protected List<Constraint> getConstraints() {
        return Arrays.asList(
                new SingleClockConstraint(Inequality.GreaterThan, false, 5, clockDimensions.get(0)),
...
//                new SingleClockConstraint(Inequality.LessThan, true, 17, clockDimensions.get(0)),
                new SingleClockConstraint(Inequality.LessThan, true, 17, clockDimensions.get(1)),
//                new SingleClockConstraint(Inequality.LessThan, true, 17, clockDimensions.get(2)),
                ...
                new TwoClockConstraint(Inequality.LessThan, true, 7,      clockDimensions.get(0), clockDimensions.get(2)),

//                new TwoClockConstraint(Inequality.GreaterThan, true, 0, clockDimensions.get(1), clockDimensions.get(2)),
                new TwoClockConstraint(Inequality.LessThan, false, 8,   clockDimensions.get(1), clockDimensions.get(2))
        );
    }
}
