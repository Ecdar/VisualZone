...
public class Task7ConstraintPanel extends ConstraintPanel {

    public Task7ConstraintPanel(double prefWidth) {
        super(prefWidth);
    }
...
//                new SingleClockConstraint(Inequality.LessThan, true, 18, clockDimensions.get(2)),

//                new TwoClockConstraint(Inequality.GreaterThan, true, 0, clockDimensions.get(0), clockDimensions.get(1)),
                new TwoClockConstraint(Inequality.LessThan, true, 6,      clockDimensions.get(0), clockDimensions.get(1)),

                new TwoClockConstraint(Inequality.GreaterThan, true, 0, clockDimensions.get(0), clockDimensions.get(2)),
                new TwoClockConstraint(Inequality.LessThan, true, 5,      clockDimensions.get(0), clockDimensions.get(2)),

                new TwoClockConstraint(Inequality.GreaterThan, true, -4, clockDimensions.get(1), clockDimensions.get(2)),
